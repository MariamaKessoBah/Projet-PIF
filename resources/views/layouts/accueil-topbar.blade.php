    ...
    <div class="topbar d-flex align-items-center">
      <div class="container d-flex justify-content-center justify-content-md-between">
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com"> ctcom@microfinance-ess.gouv.sn</a></i>
          <i class="bi bi-phone d-flex align-items-center ms-4"><span>(+221) 33 889 80 33</span></i>
        </div>
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            {{-- <li><a href="#loginModal" data-bs-toggle="modal"><i class="bi bi-person"></i> Connexion</a></li> --}}
            <li>
